...
const Hero = ({trending}:HeroProps):JSX.Element => {
  ...
  useEffect(()=>{
    const rendomMovie = trending[Math.floor(Math.random()*trending.length)]
  ...
  return(
    <div className="flex flex-col space-y-2 py-20 md:space-y-4 lg:h-[65vh] lg:pb-12 lg:center">
      ...
      <div>
      <button className="flex justify-center items-center space-x-2 bg-white/60 font-bold text-black  w-[200px] h-[50px] rounded-full ">
