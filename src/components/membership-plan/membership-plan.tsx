...
const MembershipPlan = ({subscription}:MembershipPlanProps)=>{
    ...
    const openPortal = async ()=>{
        setLoading(true)
        const payload = { user_id: subscription.customer.metadata}
    ...
    return (
        <div className='mt-6 grid grid-cols-1 gap-x-4 border px-4 py-4 md:grid-cols-4 md:bordder-x-0  md:border-t md:border-b-0  md:pb-0'>
            <div className='space-y-2 py-4 '>
                ...
                <button onClick={openPortal} className='h10 w-3/5 whitespace-nowrap transition-all bg-gray-300 py-2 text-sm font-medium text-black shadow-md hover:bg-gray-200 md:w-4/5 '>
