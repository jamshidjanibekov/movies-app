  ...
  return(
    <div className='min-h-screen '>
        ...
        <div className=' flex flex-col space-y-4 text-center pt-5'>
            ...
            <p className='text-xl text-shadow'>Relaxing with watching your favourite moves and tv</p>
        </div>
            ...
            {/*    Card Plan*/}
                <div className='max-w-sm cursor-pointer bg-white/20 px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500'>
                    ...
                    <div className='relative'>
                        ...
                        />
                        <p className='absolute top-0 bg-black/90 text-white font-semibold py-1 px-3 rounded-tl-lg rounded-br-lg '>$10 </p>
